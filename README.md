...
# SMMO
A friend told me about this game and how there are no public up-to-date bots available for it. I took it literal and coded a bot within hours.

Issues you will encounter if you want to do the same thing:
- Possible Bans
- Captcha
<br/>
<br/>
And that's why this repository exists. I show you how I made my Bot solve the Captcha. Their captcha consists of 4 deformed game assets that get generated by their server. <img src="https://user-images.githubusercontent.com/42414542/142768070-788a0f46-696d-41dc-8e1f-f0460e2d9ebf.png" align="right"/> And the second I saw these captchas. I knew that I wouldn't have to pay cheap working indians sitting 8 hours a day in front of their desktop, 10 cents an hour, to solve the captchas I send them.
